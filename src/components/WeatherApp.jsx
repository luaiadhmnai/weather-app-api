...
const WeatherApp = () => {
  ...
  const backgroundImages = {
    ...
    Haze: 'linear-gradient(to right, #5bc8fb, #80eaff)',
  ...
  return (
    <div className="container" style={{backgroundImage}}>
      <div className="weather-app" style={{backgroundImage: backgroundImage && backgroundImage.replace ? backgroundImage.replace("to right", "to top") : null,}}>
        ...
        {loading ? (<img className='loader' src={loadingGif} alt='loadeing' />) : data.notFound ? (<div className='not-found'>Not Found 😒</div>) : (
          <>
